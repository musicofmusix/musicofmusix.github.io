...
## Screen 1
<img src="/assets/img/sairi/screen1.webp" class="w-full sm:w-2/3 h-auto mx-auto">

## Screen 2
<img src="/assets/img/sairi/screen2.webp" class="w-full sm:w-2/3 h-auto mx-auto">
...
<img src="/assets/img/sairi/glitchtext_demo.gif" class="w-full sm:w-2/3 h-auto mx-auto">

- A customisable polka-dot effect for backgrounds, implemented in URP Shadergraph

<img src="/assets/img/sairi/polkadots_demo.webp" class="w-full sm:w-2/3 h-auto mx-auto">
...
<img src="/assets/img/sairi/pinkline_demo.gif" class="w-full sm:w-2/3 h-auto mx-auto">

- Real-time depth-based shader replacement for special masking effects

<img src="/assets/img/sairi/curtain_demo.gif" class="w-full sm:w-2/3 h-auto mx-auto">
