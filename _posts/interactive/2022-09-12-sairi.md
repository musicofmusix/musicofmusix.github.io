...
title: "Sairi"
title_repeat: 15
subtitle: "2D & 3D Hybrid Game UI Demo"
comment: "Unity, VRoid Studio, Blender 3D, C#, Python"
date: 2022-09-12
abstract: >
 This project was born as an attempt to blur the lines between visually sophisticated but static graphic posters and interactive but simple game UI. It demonstrates an interface with a high focus on stylised visual aesthetics, while maintain interactivity. Common design practices involving decorating the canvas with geometric shapes, typography, and visual effects are combined in the Unity game engine. Various rendering techniques, often hand-implented in Unity's URP Shadergraph are used.
thumbnail: /assets/img/sairi/main_demo.gif
permalink: /sairi-project
---
<img src="/assets/img/sairi/main_demo.gif" class="w-full sm:w-2/3 h-auto mx-auto">
...
## Screen 1
<img src="/assets/img/sairi/screen1.webp" class="w-full sm:w-1/2 h-auto mx-auto">

## Screen 2
<img src="/assets/img/sairi/screen2.webp" class="w-full sm:w-1/2 h-auto mx-auto">
...
<img src="/assets/img/sairi/glitchtext_demo.gif" class="w-full sm:w-1/2 h-auto mx-auto">

- A customisable polka-dot effect for backgrounds, implemented in URP Shadergraph
<img src="/assets/img/sairi/polkadots_demo.webp" class="w-full sm:w-1/2 h-auto mx-auto">
...
<img src="/assets/img/sairi/pinkline_demo.gif" class="w-full sm:w-1/2 h-auto mx-auto">

- Realtime depth-based shader replacement for special masking effects
<img src="/assets/img/sairi/curtain_demo.gif" class="w-full sm:w-1/2 h-auto mx-auto">
...
<img src="/assets/img/sairi/doodle.webp" class="w-full sm:w-2/3 h-auto mx-auto">

## Randomised Bezier Curve Implementation Log
<img src="/assets/img/sairi/bezier_doodle.webp" class="w-full sm:w-2/3 h-auto mx-auto">
